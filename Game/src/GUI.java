	...
	private class MenuStartListener implements ActionListener
	{
		...
		public MenuStartListener(JFrame frame)
		{
			...
			playerHelp = "How To Play: " + "\n" + "\nWelcome to Aerial Ace! Your mission "
					...
					+ "If there is a full wave of planes coming at you when you die, you may be trapped momentarily on \n"
					+ "this mortal plane by being stuck as a ghost doomed to watch the planes advance and \n"
